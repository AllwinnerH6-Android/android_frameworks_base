...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadStringSetting(stmt, Settings.Global.CAPTIVE_PORTAL_FALLBACK_URL,
                    R.string.def_captive_portal_fallback_url);

            loadStringSetting(stmt, Settings.Global.CAPTIVE_PORTAL_OTHER_FALLBACK_URLS,
                    R.string.def_captive_portal_other_fallback_urls);
