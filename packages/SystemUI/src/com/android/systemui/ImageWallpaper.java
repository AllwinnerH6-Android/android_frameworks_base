...
public class ImageWallpaper extends WallpaperService {
    ...
    class DrawableEngine extends Engine {
        ...
        private boolean mNeedUpdateFixSurface;
            ...
            mLoader = new AsyncTask<Void, Void, Bitmap>() {
                ...
                protected void onPostExecute(Bitmap b) {
                    ...
                    if (mNeedsDrawAfterLoadingWallpaper) {
                        if(mNeedUpdateFixSurface){
                            Log.d(TAG,"fixed need update surface");
                            updateFixedSurface(true /*forceRelayout*/, false, false);
                        }
                        drawFrame();
                    }
        ...
        private void updateBitmap(Bitmap bitmap) {
            ...
            mNeedUpdateFixSurface = (mBackgroundWidth != mLastRequestedWidth) || (mBackgroundHeight != mLastRequestedHeight);
