...
public class NetworkControllerImpl extends BroadcastReceiver
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (action) {
            ...
            case TelephonyIntents.ACTION_RADIO_STATE_CHANGED:
                RadioState = intent.getStringExtra(PhoneConstants.STATE_KEY);
                Utils.mRadioAvailable = RadioState.equals("on");
                updateMobileControllers();
                break;
    ...
    protected void updateNoSims() {
        ...
        hasNoSubs = hasNoSubs && Utils.mRadioAvailable;
        simDetected = simDetected && Utils.mRadioAvailable;
