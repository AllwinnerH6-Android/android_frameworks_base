...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private final Runnable mScreenrecordRunnable = new Runnable() {
        @Override
        public void run() {
            Log.d("chongyuzhao","takeScreenrecord");
            takeScreenrecord();
        }
    };
        ...
        synchronized (mLock) {
            ...
            switch (orientation) {
                ...
                default:
					...
					switch(SystemProperties.getInt("ro.default.rotation",0)){
                        case 0:
                            return Surface.ROTATION_0;
                        case 90:
                            return Surface.ROTATION_90;
