...
public final class SystemServer {
    ...
    private static final String START_WATCHDOG = "StartWatchdog";
    ...
    private void startOtherServices() {
        ...
        if (mFactoryTestMode != FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            if("homlet".equals(SystemProperties.get("ro.product.platform", "pad"))) {
                try {
                    ...
                    Class<?> clazz = Class.forName("com.android.server.AudioDeviceManagerObserver");
        ...
        mActivityManagerService.systemReady(() -> {
            ...
            traceEnd();
            // AW:BOOTEVENT
            sAwSystemServerIns.logBootEvent("SystemServer:NetworkPolicyManagerServ systemReady");

            SystemServerInitThreadPool.get().submit(() -> {
                TimingsTraceLog traceLog = new TimingsTraceLog(
                        SYSTEM_SERVER_TIMING_ASYNC_TAG, Trace.TRACE_TAG_SYSTEM_SERVER);
                traceLog.traceBegin(START_WATCHDOG);
